...
float speciaCases(void){
  ...
  else if( (previousError==-2) && (maxError==3) ){error=-1;maxError=0;}//junction atfer loop
  else if( (previousError==-2) && (maxError==4) ){error=-1;maxError=0;}//junction atfer loop
  else if( (previousError==-2) && (maxError==2) ){error=1;maxError=0;}//junction atfer loop
